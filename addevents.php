...
<body bgcolor="#E5E8E8">
    <form method="post" action="addevents1.php">
    ...
    background:#000000;margin-top:-8px;"></a>';
        ...
        <a href="offers.php">        <a href="adminevents.php"><input type="button" value="OFFERS   "></a>
</a>
        ...
        <div class="adminevents">
            <table style="margin-top:30px;">
             ...
             <div style="margin-left:300px;margin-top:-90px;">
                 ...
                 <table >
                <tr><td>
                   <input type="text"  placeholder="Eventname" name="eventname"></td></tr><tr><td>
            
                     <input type="date"  placeholder="Eventdate" name="eventdate"></td></tr><tr><td>
                <input type="text"  placeholder="Eventprice" name="eventprice"></td></tr>
