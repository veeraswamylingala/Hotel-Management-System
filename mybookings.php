...
<body bgcolor="#E5E8E8">
    ...
    <img src=".\Im\78.jpg"style="height:100%;width:100%;margin-top:-240px;margin-bottom:0px;">
        ...
        <div class="output" style="width:500px;height:300px;background:rgba(0,0,0,0.7);text-align:center;position:absolute;margin-top:-450px;margin-left:500px;color:white;font-family:serif">
...
$sql = "SELECT * FROM bookroom where uname='$uname'";
        ...
        echo "<table style=margin-left:30px;margin-top:30px>";
            ...
            echo "<tr>";
                ...
                echo "<td>" . $row['rooms']. "</td>";
                  echo "<td>" . '<a href="cancelbooking.php
                  ?cancelbooking=$row[checkin]"><input type="submit" value="CANCEL" name="cancelbutton"></a>'. "</td>";
